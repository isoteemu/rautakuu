...
// 	Uusi myyntierä
	public static void uusiProjekti(){
		try{			
			...
			int maara2;
			double hinta2;
// Kysytään uuden myyntierän tarvitsemat tiedot
			System.out.print("\nMyyntierän nimi > ");
			projekti tiedot;
...
// Tallennetaan projektin tiedot. Tää olio jäi myöhemmin tehdyn muutoksen jälkeen "tarpeettomaksi" mutta en ole siistinyt. Vastaavia voi löytyä lisää
	...
	public static void myyntiValikko(){
		...
		switch(valinta){
			...
			case 2:
				...
				myyntiValikko();
			case 0:
// Tallenetaan tehdyt muutokset ennen ohjelman lopettamista
