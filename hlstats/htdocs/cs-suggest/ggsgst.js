...
function installACPartTwo(){
  ...
  if(pa) {
    _completeSearchString="cs-suggest/query.php/";
  } else {
    _completeSearchString="cs-suggest/query.php/"+_searchString;
  }

  //_completeSearchEnString=_completeSearchString+"?hl="+_enString;
  _completeSearchEnString=_completeSearchString;
  ...
  ca=1;
  Aa=1;
  _completeDiv.style.background="#15154D";
  _completeDiv.style.borderRight="#001B73 "+ca+"px solid";
  _completeDiv.style.borderLeft="#001B73 "+ca+"px solid";
  _completeDiv.style.borderTop="#001B73 "+Aa+"px solid";
  _completeDiv.style.borderBottom="#001B73 "+Aa+"px solid";
  _completeDiv.style.zIndex="20";
  ...
  _completeDiv.style.backgroundColor="#15154D";
...
newwin=function(){
  PrivoxyWindowOpen(_inputField.value);
  hideCompleteDiv();
  return false
}
;
...
function setStyleForElement(c,name){
  ...
  switch(name.charAt(0)){
    ...
    case "l":
      ...
      break;
    case "a":
      c.style.backgroundColor="#15154D";
      c.style.color="#EEEEEE";
      if(c.displaySpan){
        c.displaySpan.style.color="#002E8A"
      }
      break;
    case "b":
      c.style.backgroundColor="#002E8A";
      c.style.color="#EEEEEE";
      if(c.displaySpan){
...
function callGoogle(Rb){
  ...
  if(_xmlHttp){
    ...
    _xmlHttp.open("GET",_completeSearchEnString+"?q="+Rb,true);
